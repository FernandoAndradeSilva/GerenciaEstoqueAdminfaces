...
import com.adminfaces.estoque.infra.model.Filter;
import com.adminfaces.estoque.model.Car;
import com.adminfaces.estoque.service.CarService;
...
import static com.adminfaces.estoque.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.adminfaces.estoque.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.adminfaces.estoque.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.adminfaces.estoque.infra.model.SortOrder.DESCENDING
                            : com.adminfaces.estoque.infra.model.SortOrder.UNSORTED;
                }
